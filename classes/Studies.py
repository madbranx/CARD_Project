...
class Studies:
    ...
    def combinedArcs(self, foldername, time_end, time_steps, T_walls,n_axial, n_radial, log=False):
        results_ignition_1d, results_extinction_1d, T_walls_1d, T_walls_ext_1d = self.arcs(foldername, 1, time_end, time_steps, T_walls, n_axial*2, log=log, plotting=False)
        results_ignition_2d, results_extinction_2d, T_walls_2d, T_walls_ext_2d = self.arcs(foldername, 2, time_end, time_steps, T_walls, n_axial, n_radial, log=log, plotting=False)
